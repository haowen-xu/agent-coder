...
本目录用于沉淀需求讨论、范围确认与版本边界。

## 文件约定

- 建议文件名：`YYYY-MM-DD-<topic>.md`
- 每个需求文档至少包含：
  - 背景与目标
...
- [2026-03-20-agent-autocoding-requirements-v3.md](2026-03-20-agent-autocoding-requirements-v3.md)
- [2026-03-20-agent-autocoding-requirements-v4.md](2026-03-20-agent-autocoding-requirements-v4.md)
